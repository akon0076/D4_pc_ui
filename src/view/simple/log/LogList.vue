            ...
            <el-row>
                ...
                <el-col>
                    ...
                    <div style="float: right; margin-bottom: 15px">
                        ...
                        <el-button  type="primary" @click="addLog()"  v-permission:simple_log_Log_Add >新增日志</el-button>
                    </div>
                    <div class="table-control">
                        <el-table v-loading="tableLoading" size="small" class="table-style" :data="logs" border highlight-current-row @current-change="handleCurrentChange">
                            ...
                            <el-table-column show-overflow-tooltip align="left" prop="name" label="日志名称" min-width="100" fixed="left" sortable resizable show-overflow-tooltip>
                                <template slot-scope="scope">
                                        <p v-on:click="displayLog(logs[scope.$index].eid)"
                                           style="text-decoration: underline">
                                            {{ logs[scope.$index].name }}
                                        </p>
                                </template>
                            </el-table-column>
                                    ...
                                    <el-table-column align="left" clalss="setCenter" prop="ipAddress" label="IP地址" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
                                    <el-table-column align="left" clalss="setCenter" prop="logType" label="日志类型" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
                                    <el-table-column align="left" clalss="setCenter" prop="entity" label="操作实体" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
                                    <el-table-column align="left" clalss="setCenter" prop="operationType" label="操作类型" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
                                    <el-table-column align="left" clalss="setCenter" prop="logDate" label="操作时间" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
                                    <el-table-column align="left" clalss="setCenter" prop="operationContent" label="操作内容" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
                                    <el-table-column align="left" clalss="setCenter" prop="url" label="url" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
                                    <el-table-column align="left" clalss="setCenter" prop="module" label="模块" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
                            ...
                            <el-table-column label="操作" min-width="120" resizable>
                                <template slot-scope="scope">
                                    <template>
                                        <el-button @click="editOrganation(logs[scope.$index].eid)" type="text" size="small" v-permission:simple_log_Log_Edit >编辑</el-button>
                                    </template>
                                    <template>
                                        <el-button @click="deleteLog(logs[scope.$index].eid)" type="text" size="small" v-permission:simple_log_Log_Delete ><p
    ...
    export default {
        ...
        methods: {
            ...
            addLog(){
                //新增日志
                var router = this.$router;
                router.push({path: '/simple/log/log/add', query: {}});
            },
            editOrganation(logId){
                //编辑日志
                var router = this.$router;
                router.push({path: '/simple/log/log/edit/'+logId, query: {}});
            },
