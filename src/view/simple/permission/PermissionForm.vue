        ...
        <el-card class="box-card card-head" style="margin: 0px; width: 100%; min-height: 99%">
            ...
            <div class="text item">
                <el-form ref="permissionForm" :model="permission" label-width="150px" :rules="rules">
                    ...
                    <el-col :span="12">
                        <el-form-item>
                            <el-button type="primary" @click="submitPermission()"    :loading="isSubmiting" v-permission:simple_permission_Permission_Edit >提交</el-button>
                        </el-form-item>
                    </el-col>
                </el-form>
            </div>
...
export default {
    ...
    data() {
        ...
        alerts:{ remarks:[{title:"功能说明",description:"权限点编码命名格式请参考Module.json和操作文档执行！"},],
    ...
    methods: {
        ...
        findPermissionForEdit(permissionId)//查找权限点
        {
            PermissionService.findPermissionForEdit(permissionId).then((resp) => {
    ...
    created() {
        ...
        if(this.permissionId)//编辑
        {
            this.findPermissionForEdit(this.permissionId);
        }
        else//新增
        {
