        ...
        <el-col>
          ...
          <div class="table-control">
            <el-table v-loading="tableLoading" size="small" class="table-style" :data="operators" border
              ...
              <el-table-column align="left" prop="name" label="操作员名称" min-width="100" fixed="left"  resizable
              ...
              <el-table-column align="left" clalss="setCenter" prop="code" label="编码" min-width="80"  resizable
                               show-overflow-tooltip></el-table-column>
              <el-table-column align="left" clalss="setCenter" prop="status" label="状态" min-width="50"
                               resizable show-overflow-tooltip></el-table-column>
              <el-table-column align="left" clalss="setCenter" prop="type" label="类型" min-width="60"  resizable
                               show-overflow-tooltip></el-table-column>
