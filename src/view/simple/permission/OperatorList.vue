        ...
        <el-col>
          ...
          <div class="table-control">
            <el-table v-loading="tableLoading" size="small" class="table-style" :data="operators" border
              ...
              <el-table-column align="left" clalss="setCenter" prop="status" label="状态" min-width="80"
                               resizable show-overflow-tooltip></el-table-column>
              <el-table-column align="left" clalss="setCenter" prop="type" label="类型" min-width="80"  resizable
                               show-overflow-tooltip></el-table-column>
