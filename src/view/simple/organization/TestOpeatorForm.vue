...
<template>
    <div class="spanControl-list" style="width: 100%;margin-left: 0!important;">
        <el-card class="box-card card-head" style="margin: 0px; width: 100%; min-height: 99%">
            ...
            <div class="text item">
                <el-form ref="testOpeatorForm" :model="testOpeator" label-width="150px" :rules="rules">
                                    <el-col :span="12">
                                        <el-form-item label="名称" prop="name">
                                            <el-input type="input" v-model="testOpeator.name"
                                    ...
                                    <el-col :span="12">
                                        <el-form-item label="员工姓名" prop="staffName">
                                            <el-input type="input" v-model="testOpeator.staffName"
                                                      placeholder="名称" clearable autosize
                                    ...
                                    <el-col :span="12">
                                        <el-form-item label="身份证号" prop="staffIdNumber">
                                            <el-input type="input" v-model="testOpeator.staffIdNumber"
                                ...
                                <el-col :span="12">
                                    <el-form-item label="年龄" prop="staffAge">
                                        <el-input type="number" step="1" v-model="testOpeator.staffAge"
                                ...
                                <el-col :span="12">
                                    <el-form-item label="薪水" prop="salary">
                                        <el-input type="number" step="0.01" v-model="testOpeator.salary"
                                ...
                                <el-col :span="12">
                                    <el-form-item label="分数" prop="score">
                                        <el-input type="number" step="1" v-model="testOpeator.score"
                                ...
                                <el-col :span="12">
                                    <el-form-item label="入职日期" prop="dateOfJoin">
                                        <el-date-picker clearable
                                                v-model="testOpeator.dateOfJoin"
                                                align="right"
                                                type="date"
                                                placeholder="入职的时间"
                                ...
                                <el-col :span="12">
                                    <el-form-item label="单位" prop="organizationName">
                                        <el-autocomplete
                                                class="inline-input"
                                                value-key="name"
                                                v-model="testOpeator.organizationName"
                                ...
                                <el-col :span="12">
                                    <el-form-item label="是否有效" prop="enabled">
                                        <el-radio-group v-model="testOpeator.enabled">
                                ...
                                <el-col :span="24">
                                    <el-form-item label="备注" prop="remark">
                                            ...
                                            <el-input type="textarea" v-model="testOpeator.remark"
                    ...
                    <el-col :span="12">
                        <el-form-item>
                            <el-button type="primary" @click="submitTestOpeator()"    :loading="isSubmiting" v-permission:simple_organization_TestOpeator_Edit >提交</el-button>
                        </el-form-item>
                    </el-col>
                </el-form>
            </div>
...
export default {
    ...
    methods: {
        submitTestOpeator() {
            var refs = this.$refs;
            refs['testOpeatorForm'].validate(valid => {
            if (valid) {
            if(this.testOpeator.eid)//编辑测试操作员
            {
            this.updateTestOpeator();
            }
            else//保存测试操作员
            {
            this.saveTestOpeator();
            }
            } else {
            return false
            }
        ...
        saveTestOpeator()//保存测试操作员
        {
            this.isSubmiting = true;
            TestOpeatorService.saveTestOpeator(this.testOpeator).then((resp) => {
                this.isSubmiting = false;
                var router = this.$router;
                router.push({path: '/simple/organization/testOpeator'})
        }).catch((error) => {
            this.isSubmiting = false;
            this.$message({
            type: 'error',
        ...
        updateTestOpeator()//编辑测试操作员
        {
            this.isSubmiting = true;
            TestOpeatorService.updateTestOpeator(this.testOpeator).then((resp) => {
                this.isSubmiting = false;
                var router = this.$router;
                router.push({path: '/simple/organization/testOpeator'})
        }).catch((error) => {
        ...
        findTestOpeatorForEdit(testOpeatorId)//查找测试操作员
        {
            TestOpeatorService.findTestOpeatorForEdit(testOpeatorId).then((resp) => {
        ...
        createTestOpeator()//创建新的测试操作员
        {
            TestOpeatorService.createTestOpeator().then((resp) => {
                this.prepareForEdit(resp.data);
        }).catch((error) => {
            this.$message({
            type: 'error',
        ...
        prepareForEdit(testOpeatorEditDto)
        {
            this.testOpeator = testOpeatorEditDto.testOpeator;

            this.genderCodeTables = testOpeatorEditDto.genderCodeTables;
            this.organizationOrganizations = testOpeatorEditDto.organizationOrganizations
        },
        ...
        searchOrganizationName(queryString, cb) {
            ...
            handleSelectOrganizationName(item){
                this.testOpeator.organizationId = item.eId;
            },
    },
    created() {
        this.testOpeatorId = this.$route.params.testOpeatorId;
        if(this.testOpeatorId)//编辑
        {
            this.findTestOpeatorForEdit(this.testOpeatorId);
        }
        else//新增
        {
            this.createTestOpeator();
        }
    },
}
</script>
